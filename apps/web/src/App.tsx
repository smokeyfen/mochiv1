...
function DeliveryCenter({ snapshotId, delivery, onDelivery }: { readonly snapshotId:string; readonly delivery:DeliveryManifest; readonly onDelivery:(delivery:DeliveryManifest)=>void }) {
